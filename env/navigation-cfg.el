...
(general-define-key
 ...
 "s b" '(helm-do-ag-buffers :which-key "search buffers")
 ...
 ". g" '(evil-goto-definition :which-key "goto definition")
 ". w" '(avy-goto-word-1 :which-key "goto word")
 ". l" '(avy-goto-line :which-key "goto line")
 ". d" '(:ignore t :which-key "goto delete")
 ". d r" '(avy-kill-region :which-key "goto delete region")
 ". d l" '(avy-kill-whole-line :which-key "goto delete line")
 ". y" '(:ignore t :which-key "goto yank")
 ". y r" '(avy-kill-ring-save-region :which-key "goto yank region")
 ". y l" '(avy-kill-ring-save-whole-line :which-key "goto yank line")
